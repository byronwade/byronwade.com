						...
						<div className="space-y-1 px-2">
							...
							<div className="border-t border-border/50 pt-3 mt-2 space-y-2">
								<Button
									asChild
									variant="outline"
									className="w-full justify-start border-border/50 hover:border-yellow-400/50 hover:bg-yellow-400/10 hover:text-yellow-600 transition-all duration-300 min-h-[48px] py-3 touch-target"
								>
								...
								<Button
									asChild
									className="w-full justify-start bg-yellow-600 hover:bg-yellow-700 text-black font-semibold transition-all duration-300 min-h-[48px] py-3 touch-target"
								>
									<Link
										prefetch={true}
										href="/work-with-me"
