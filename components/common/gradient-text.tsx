...
export function GradientText({
	...
	const gradientClasses = {
		accent:
			"bg-gradient-to-r from-yellow-600 via-amber-600 to-yellow-500 dark:from-yellow-500 dark:via-amber-500 dark:to-yellow-400",
		...
		purple:
			"bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 dark:from-purple-500 dark:via-indigo-400 dark:to-blue-400",
		blue: "bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-500 dark:to-cyan-400",
	};

	return (
		<Component className={cn("bg-clip-text text-transparent", gradientClasses[variant], className)}>
			{children}
		</Component>
	);
}
