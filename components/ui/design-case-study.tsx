			...
			<Tabs defaultValue="overview" className="w-full">
				...
				<TabsContent value="overview" className="space-y-6">
					...
					<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
						{challenge && (
							<Card className="border-border/30 bg-secondary/50 transition-shadow duration-150 hover:shadow-xl">
								<CardHeader>
				...
				<TabsContent value="process" className="space-y-6">
					<div className="space-y-4">
						{processSteps.map((step, index) => (
							<Card
								key={step.title}
								className="border-border/30 bg-secondary/50 transition-shadow duration-150 hover:shadow-xl"
							>
								<CardHeader>
				...
				<TabsContent value="results" className="space-y-6">
					...
					{/* Testimonial */}
					{testimonial && (
						<Card className="border-brand/20 bg-gradient-to-br from-brand/5 to-brand/10 transition-shadow duration-150 hover:shadow-xl">
