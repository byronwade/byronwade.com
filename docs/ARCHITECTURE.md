...
| `/contact` | Contact form (Resend via `app/actions/send-email.ts`) |
| `/privacy`, `/terms` | Legal |
...
```
components/
  layout/        # Header, footer, site shell, layout wrapper
  sections/      # Shared section pieces (background)
  home/          # Homepage building blocks
  blog/          # Blog UI
  project/       # Project preview UI
  portfolio/     # Figma viewer
  common/        # Theme, analytics, effects, error boundary, image
