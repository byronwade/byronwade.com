        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-12 md:mb-0 pr-0 md:pr-8">
              <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-stone-700 to-stone-900">
                Byron Wade
              </h1>
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                ...
                <Badge variant="secondary" className="text-lg py-2 px-4 bg-white/50 backdrop-blur-sm"><Book className="w-5 h-5 mr-2 inline" /> CS Student</Badge>
                <Badge variant="secondary" className="text-lg py-2 px-4 bg-white/50 backdrop-blur-sm"><TrendingUp className="w-5 h-5 mr-2 inline" /> Innovator</Badge>
              </div>
            </div>
