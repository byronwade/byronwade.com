            ...
            <Tabs defaultValue="themes" className="mb-8" onValueChange={(value) => setActiveTab(value as 'themes' | 'merchandise')}>
              ...
              <TabsContent value="themes">
                ...
                {filteredProducts.length === 0 && (
                  <p className="text-center text-gray-500 dark:text-gray-400 mt-8">No products found matching your search criteria.</p>
                )}
              </TabsContent>
              <TabsContent value="merchandise">
                ...
                {filteredProducts.length === 0 && (
                  <p className="text-center text-gray-500 dark:text-gray-400 mt-8">No merchandise found matching your search criteria.</p>
                )}
              </TabsContent>
            </Tabs>
