        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 pr-0 md:pr-8">
            ...
            <div className="md:hidden">
              <Image 
                ...
                height={300} 
                alt="Byron Wade" 
                className="rounded-full shadow-2xl border-4 border-white mx-auto mb-8"
              />
            </div>
          </div>
          <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-xl">
            ...
            <form className="space-y-4">
              ...
              <Button className="w-full bg-stone-800 hover:bg-stone-700 text-white text-lg py-3 rounded-full transition-all duration-300 transform hover:scale-105">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/3 mb-8 md:mb-0">
              <Image 
                ...
                height={400} 
                alt="Byron Wade" 
                className="rounded-full shadow-2xl border-4 border-stone-200"
              />
            </div>
