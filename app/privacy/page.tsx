			...
			<SiteShell flush className="pb-[var(--space-section-y)]">
				<article className="prose max-w-none">
					...
					<ul>
						...
						<li>
							<strong>Usage data.</strong> We collect anonymized analytics (pages visited,
							performance metrics, approximate region) through privacy-friendly tooling to improve
							the site.
						</li>
						<li>
					...
					<p>
						We keep inquiry information only as long as necessary to respond and maintain our
					...
					<p>
						...
						any time by contacting us. We will respond within a reasonable timeframe.
					</p>

					<h2>Contact</h2>
					<p>
						Questions about this policy? Reach out through our <a href="/contact">contact page</a>{" "}
