...
const products: Product[] = [
	{
		...
		features: ["Headless CMS built on Next.js", "Drag-and-drop interface", "Developer-friendly with full customization", "Database-agnostic approach", "Serverless compatibility"],
	...
	},
	{
		...
		features: ["HTML and Tailwind CSS based", "Modular component design", "Responsive layout", "Dark mode support", "Customizable themes"],
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		features: ["Comprehensive courses for various trades", "Interactive lessons and quizzes", "Progress tracking", "Certification programs", "Community forums for peer support"],
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		features: ["AI-powered content suggestions", "Multi-platform publishing", "Analytics dashboard", "Collaboration tools", "SEO optimization features"],
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		features: ["Business profile management", "Local SEO tools", "Customer review management", "Social media integration", "Analytics and reporting"],
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		features: ["Job scheduling and dispatching", "Customer management", "Invoicing and payments", "Mobile app for field technicians", "Reporting and analytics"],
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		features: ["Scalable architecture", "Custom product configurator", "Integration with existing ERP system", "Advanced analytics dashboard", "Multi-language and multi-currency support"],
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		features: ["Real-time data processing", "Machine learning models for predictive analytics", "Secure user authentication and data encryption", "Interactive data visualization", "API integration with major financial institutions"],
		image: "/placeholder.svg?height=400&width=600",
...
export default function ProductsPage() {
	...
	const filteredProducts = activeTab === "all" ? products : products.filter((product) => (activeTab === "products" && product.category === "product") || (activeTab === "client_projects" && product.category === "client") || (activeTab === "completed" && product.status === "completed") || (activeTab === "in_development" && product.status === "in_development"));
