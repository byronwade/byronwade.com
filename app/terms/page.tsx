		...
		<SiteShell>
			<article className="prose dark:prose-invert mx-auto max-w-3xl py-16 prose-headings:font-semibold prose-a:text-brand prose-headings:tracking-tight hover:prose-a:text-brand">
				<header className="not-prose mb-10">
					<h1 className="font-semibold text-3xl tracking-tight sm:text-4xl">Terms of Service</h1>
				...
				<p>
					...
					interfere with its operation, or attempt to access it in ways other than the interfaces we
					provide.
				</p>
				...
				<p>
					Information about web development and plumbing services is provided for general reference.
					Quotes, timelines, and pricing are estimates until confirmed in a written agreement.
					Plumbing services are provided in accordance with applicable California licensing and
					regulations.
				</p>
				...
				<p>
					...
					though we work hard to keep it fast and reliable.
				</p>
